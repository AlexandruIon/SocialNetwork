...
public class PersonResource {
    ...
    /**
     * Saves changes to a given address linked to an person
     *
     * @param personId  id of the person
     * @param addressId id of the address to save
     * @param address   the address with changes to save
    ...
    /**
     * @param personId the id of the person
     * @return communication channels linked with the person; empty if no results are found
     */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/{personId}/" + CONTACT)
    public Collection<Contact> getgetContacts(@PathParam("personId") String personId) {
    ...
    public Contact getCommunicationChannel(@PathParam("personId") String personId, @PathParam("contactId") String contactId) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/{personId}/" + CONTACT + "/{contactId}")
    public Contact updateCommunicationChannels(@PathParam("personId") Long personId, @PathParam("communicationChannelId") Long contactId, CommunicationChannel communicationChannel) {
        return personService.updateContact(personId, contactId);
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/{personId}/" + CONTACT + "/{contactId}")
    public void deleteContact(@PathParam("personId") Long personId, @PathParam("contactId") Long contactId) {
